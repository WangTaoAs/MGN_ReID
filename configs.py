...
parser.add_argument("--cuda", type=int, default=2, help='dataset directory')
...
parser.add_argument('--resize', type=tuple, default=(384, 128), help='resize') #(256, 128) (384, 128)
...
parser.add_argument("--erase_prob", type=float, default=0.5, help='')
...
parser.add_argument('--test_weight', type=str, default='/home/wangt/mgn_master/MGN_40.pth')
...
parser.add_argument('--lr_decay', type=int, default=40, help='')
parser.add_argument('--weight_decay', type=float, default=5e-4, help='')
parser.add_argument('--decay_type', type=str, default='step', help='')
parser.add_argument('--no_margin', default= False , help='')
parser.add_argument('--beta1', default= 0.9 , help='')
parser.add_argument('--beta2', default= 0.999 , help='')
parser.add_argument('--epsilon', default= 1e-8 , help='')
parser.add_argument('--amsgrad', action='store_true', help='')
